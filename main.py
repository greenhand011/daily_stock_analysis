...
# -*- coding: utf-8 -*-
"""
A股/ETF/基金 自选股智能分析系统 - 主程序
支持 DeepSeek、Gemini 等 AI 分析引擎
支持 Tencent 实时行情
"""
...
class StockAnalysisPipeline:
    ...
    def process_single_stock(self, code: str) -> Optional[AnalysisResult]:
        ...
        try:
            ...
            df = None
            try:
                df = self.fetcher_manager.get_daily_data(asset_code, days=100)[0]
            except Exception as e:
            ...
            stock_info = self.portfolio.get(
                asset_code,
                {"name": f"资产{asset_code}", "sector": DEFAULT_SECTOR, "cost": 0, "shares": 0}
            )
